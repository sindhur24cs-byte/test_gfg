<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-products5049/1?_gl=1*e12plo*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw--7UBhCpARIsAGJBptgDYNaYK-5jwWJNK7mrX7GVg8HqHq4R6A7AqlOEIrV2WgI41BlFYgYaAgWgEALw_wcB&gbraid=0AAAAAC9yBkDgaC1yAxh5f1iVTNR0XJgNC">Sum of Pairwise ANDs</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of integers, calculate the sum of bitwise AND for all pairs of elements such that the first index is less than the second index.</span></p>
